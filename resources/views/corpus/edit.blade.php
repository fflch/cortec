    ...
    <div class="col">
      <form method="POST" action="/corpus/{{ $corpus->id  }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="tipologia" id="tipologia" required placeholder="Ex.: Não-literário informativo" value="{{ $corpus->tipologia }}">
        </div>
        <div class="form-group">
          <label for="compilador">Compilador</label>
          <input type="text" class="form-control" name="compilador" id="compilador" required placeholder="Ex.: Henry Kučera" value="{{ $corpus->compilador }}">
        </div>
        <div class="form-group">
          <label for="ano">Ano</label>
          <input type="number" class="form-control" name="ano" id="ano" min="1500" max="2150" required placeholder="Ex.: 2018" value="{{ $corpus->ano }}">
        </div>
